...
app.get("/api/test-connect", async (req, res) => {
    try {
        ...
        //     "✅ Account retrieved:",
        //     account.id,
        //     account.business_profile?.name || "No business name"
        // );
        ...
        // console.log(
        //     `📦 Found ${products.data.length} products in Connect account`
        // );
            ...
            sessionConfig.line_items = [
                {
                    price_data: {
                        ...
                        product_data: {
                            ...
                            description:
                                "Monthly donation to support STEM education through YGBverse",
                        },
                        unit_amount: parseInt(amount) * 100, // Convert to cents
                        recurring: { interval: "month" },
                    },
