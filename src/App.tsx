...
function Frame61858() {
    ...
    return (
        <div
            ref={titleRef}
            className="content-stretch flex flex-col gap-[7px] items-center text-center leading-[0] relative w-full"
        >
            <div className="font-['Nunito:Bold',_sans-serif] font-bold relative text-[#d5adff] leading-tight overflow-hidden">
                <motion.div
                    className="mb-0 text-[42px] md:text-[44px] lg:text-[44px] leading-[1.1]"
                    initial={{ opacity: 0 }}
                ...
                >
                    ...
                    <div className="block">
                        <motion.span
                            className={`chroma-text-culture ${
                                animateCulture
                                    ? "chroma-text-culture-animate"
                                    : ""
                            }`}
                            initial={{ y: 100, opacity: 0 }}
                            animate={{
...
function FormHeroBanner({
    ...
    const mobileContainerInView = useInView(mobileContainerRef, {
        once: true,
        margin: "-10%",
    });
    const desktopContainerInView = useInView(desktopContainerRef, {
        once: true,
        margin: "-10%",
    });
    ...
    return (
        <div className="min-h-[85vh] flex items-center justify-center px-4 md:px-8 pt-[100px] md:pt-[120px] lg:pt-40 pb-8 max-w-7xl mx-auto w-full">
            ...
            {/* Desktop: Image on top, form below */}
            <div className="hidden lg:flex flex-col items-center justify-center relative w-full gap-6 lg:gap-8 xl:gap-12">
                {/* Top - Character Image */}
                ...
                {/* Bottom - Form Content */}
                <div className="flex flex-col gap-[32px] items-center relative shrink-0 w-[493px] z-[2]">
...
function Title() {
    return (
        <div
            className="content-stretch flex gap-2.5 items-start justify-center relative shrink-0 w-full"
            data-name="Title"
        >
...
function Text() {
    return (
        <div
            className="content-stretch flex flex-col gap-2.5 items-start justify-center relative shrink-0 w-full"
            data-name="Text"
        >
            <div className="font-['Nunito:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#8c92ab] text-[0px] text-center tracking-[0.36px] w-full">
                <p className="leading-[27px] text-[18px]">
                    ...
                    <span>
                        {" "}
                        isn't equally accessible or culturally relevant.
                    </span>
                </p>
            </div>
        </div>
...
function Text1() {
    return (
        <div
            className="content-stretch flex flex-col gap-6 items-center justify-start relative shrink-0 w-[470px]"
            data-name="Text"
        >
            <Frame61772 />
        </div>
        ...
        <div className="absolute content-stretch flex flex-col gap-2.5 items-center justify-center leading-[0] left-[257px] md:left-[257px] sm:left-[20px] top-[162px] md:top-[162px] sm:top-[120px]">
            ...
            >
                <p className="leading-[44px] md:leading-[44px] sm:leading-[32px]">
                    ...
                    <span className="text-[65px] md:text-[65px] sm:text-[32px] tracking-[-3.25px]">
                        %
                    </span>
                </p>
            </div>
            <div className="flex flex-col font-['Nunito:Regular',_sans-serif] font-normal justify-center relative shrink-0 text-[#8c92ab] text-[12px] md:text-[12px] sm:text-[10px] tracking-[0.12px] w-[156px] md:w-[156px] sm:w-[100px]">
                <p className="leading-[18px] md:leading-[18px] sm:leading-[14px]">
                    of heroes in kids' books and games reflect students of
                    color.
                </p>
            </div>
        </div>
...
function Frame61845({ isInView }: { isInView: boolean }) {
    return (
        <div className="absolute content-stretch flex flex-col gap-2.5 items-center justify-center leading-[0] left-[612px] md:left-[612px] sm:left-[175px] top-[233px] md:top-[233px] sm:top-[170px]">
            <div
                className="flex flex-col font-['Bungee:Regular',_sans-serif] justify-center min-w-full not-italic relative shrink-0 text-[#a047ff] text-[64px] tracking-[-3.2px]"
                style={{ width: "min-content" }}
            >
                <p className="leading-[44px] md:leading-[44px] sm:leading-[32px]">
...
function Frame61846({ isInView }: { isInView: boolean }) {
    return (
        <div className="absolute content-stretch flex flex-col gap-2.5 items-center justify-center leading-[0] left-[867px] md:left-[867px] sm:left-[280px] top-[74px] md:top-[74px] sm:top-[40px]">
            ...
            <div className="flex flex-col font-['Nunito:Regular',_sans-serif] font-normal justify-center relative shrink-0 text-[#8c92ab] text-[12px] md:text-[12px] sm:text-[10px] tracking-[0.12px] w-[156px] md:w-[156px] sm:w-[100px]">
                <p className="leading-[18px] md:leading-[18px] sm:leading-[14px]">
                    of U.S. K–5 students are kids of color—but rarely see
                    themselves in STEM content.
                </p>
            </div>
        </div>
    );
                ...
                <p className="font-['Nunito:Bold',_sans-serif] font-bold leading-[1.1] text-[48px] md:text-[56px] lg:text-[64px] whitespace-pre">
                    ...
                    <span
                        className={`chroma-text ${
                            animateMatters ? "chroma-text-animate" : ""
                        }`}
                    >
                        Matters
                    </span>
    ...
    return (
        ...
        >
            <div className="font-['Nunito:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#8c92ab] text-[0px] text-center tracking-[0.36px] w-full">
                ...
                >
                    Imagine a world where every child sees themselves as the
                    hero of their own STEM story.
                    <span className="font-['Nunito:Bold',_sans-serif] font-bold tracking-[0.36px]">
                        {" "}
                        Representation is rocket fuel for innovation.{" "}
                    </span>
                </motion.p>
            </div>
        </motion.div>
        ...
        <div className="content-stretch flex gap-[10px] items-start justify-center relative shrink-0 w-full">
            <div className="font-['Nunito:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#d5adff] text-[0px] text-center text-nowrap tracking-[1.02px]">
                <p className="font-['Nunito:Bold',_sans-serif] font-bold leading-[1.1] text-[48px] md:text-[56px] lg:text-[64px] whitespace-pre">
                    ...
                    <span
                        className={`chroma-text ${
                            animateSolution ? "chroma-text-animate" : ""
                        }`}
                    >
                        Solution
                    </span>
        ...
        <div className="content-stretch flex flex-col gap-[10px] items-start justify-center relative shrink-0 w-full">
            <div className="font-['Nunito:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#8c92ab] text-[18px] text-center tracking-[0.36px] w-full">
                <p className="leading-[27px]">
                    ...
                    <br aria-hidden="true" />
                    Kids explore, experiment, and earn rewards while building
                    real STEM skills.
                </p>
            </div>
        </div>
                ...
                <div className="absolute left-[12px] size-[50.05px] top-[9.81px]">
                    ...
                    >
                        <g clipPath="url(#clip0_31_586)">
                            <path
                                d={solutionSvgPaths.p118c5ac0}
                                stroke="#3C007A"
                                strokeMiterlimit="10"
                                strokeWidth="4.16757"
                            />
                            <path
                                d={solutionSvgPaths.p2ca46d80}
                                stroke="#3C007A"
                                strokeMiterlimit="10"
                                strokeWidth="4.16757"
                            />
                            <path
                                d="M25.0272 2.0838V47.9706"
                                stroke="#3C007A"
                                strokeMiterlimit="10"
                                strokeWidth="4.16757"
                            />
                            <path
                                d="M2.08389 25.0272H47.9707"
                                stroke="#3C007A"
                                strokeMiterlimit="10"
                                strokeWidth="4.16757"
                            />
                            <path
                                d={solutionSvgPaths.p2b0e7640}
                                stroke="#3C007A"
                                strokeMiterlimit="10"
                                strokeWidth="4.16757"
                            />
                            <path
                                d={solutionSvgPaths.p220c7380}
                                stroke="#3C007A"
                                strokeMiterlimit="10"
                                strokeWidth="4.16757"
                            />
                ...
                <div className="absolute h-[44.538px] left-[3.21px] top-[4.3px] w-[46.796px]">
                    ...
                    >
                        <g clipPath="url(#clip0_31_575)">
                            <path
                                d={solutionSvgPaths.p7c62780}
                                stroke="#D5ADFF"
                                strokeMiterlimit="10"
                                strokeWidth="4.43675"
                            />
                            <path
                                d={solutionSvgPaths.p162f6080}
                                stroke="#D5ADFF"
                                strokeMiterlimit="10"
                                strokeWidth="4.43675"
                            />
                            <path
                                d={solutionSvgPaths.p1b46f40}
                                stroke="#D5ADFF"
                                strokeMiterlimit="10"
                                strokeWidth="4.43675"
                            />
                            <path
                                d={solutionSvgPaths.p3007bc00}
                                fill="#5400AD"
                            />
                            <path
                                d={solutionSvgPaths.p16b82d00}
                                fill="#5400AD"
                            />
                            <path
                                d={solutionSvgPaths.pc37d900}
                                fill="#5400AD"
                            />
                            <path
                                d={solutionSvgPaths.p3ce21180}
                                fill="#5400AD"
                            />
                            <path
                                d={solutionSvgPaths.p14a6bb40}
                                fill="#5400AD"
                            />
                            <path
                                d={solutionSvgPaths.p14705880}
                                fill="#5400AD"
                            />
                        </g>
                        <defs>
                ...
                <div className="box-border content-stretch flex flex-col gap-[32px] h-full items-center justify-center overflow-clip p-[24px] relative z-10">
                    <div className="content-stretch flex flex-col gap-[24px] items-center justify-center relative shrink-0 w-[141px]">
                        ...
                        <div className="font-['Nunito:Bold',_sans-serif] font-bold leading-[0] relative shrink-0 text-[#a047ff] text-[18px] text-center tracking-[0.36px]">
                            <p className="leading-[20px] w-[140px] h-[40px] text-center flex items-center justify-center">
                                {title}
                            </p>
                        </div>
                    </div>
            ...
            <div className="flex flex-row items-center relative size-full">
                <div className="box-border content-stretch flex gap-[8px] sm:gap-[10px] items-center px-[12px] py-0 relative w-full">
                    <div className="font-['Nunito:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#5b6178] text-[0px] text-nowrap">
                        <p className="font-['Nunito:Bold',_sans-serif] font-bold leading-[20px] sm:leading-[24px] text-[12px] sm:text-[13px] md:text-[14px] whitespace-pre">
                            {children}
                        </p>
                    </div>
                </div>
        ...
        <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0">
            ...
            >
                <div className="font-['Nunito:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#a047ff] text-[16px] text-center text-nowrap">
                    <Status
                        status="online"
                        className="bg-white border border-[#e0daef] rounded-[16px] px-3 py-2"
                    >
                        <StatusIndicator className="animate-[flicker_2s_ease-in-out_infinite]" />
                        <StatusLabel className="text-[#4c1d95] font-['Nunito:Bold',_sans-serif] font-bold">
                            Accepting Messages
                        </StatusLabel>
                    </Status>
                </div>
...
function ContactFormSubtitle({ isInView }: { isInView: boolean }) {
    return (
        ...
        >
            <p className="leading-[20px] sm:leading-[24px] md:leading-[27px] max-w-[280px] sm:max-w-[400px] md:max-w-[500px] mx-auto">
                Be part of our journey! Get updates and opportunities to help us
                grow through our Facebook Group and Newsletter.
            </p>
        </motion.div>
    );
}
    ...
    return (
        ...
        >
            ...
            <form
                ...
                className="flex flex-col gap-[24px] items-start justify-center relative"
            >
                {/* Name and Email Row */}
...
function ContactFormSection({
    ...
    const { subscribeToMailchimp, isLoading, error, clearError } =
        useMailchimp();
    const mobileContainerRef = useRef(null);
    const desktopContainerRef = useRef(null);
    const mobileContainerInView = useInView(mobileContainerRef, {
    ...
    return (
        <div
            id="contact-section"
            className="min-h-[85vh] flex items-center justify-center px-4 md:px-8 pt-8 pb-8 max-w-7xl mx-auto w-full"
        >
            ...
            <div className="flex flex-col lg:hidden gap-8 items-center">
                ...
                <div className="flex flex-col gap-[24px] sm:gap-[32px] items-center text-center relative w-full z-[2]">
                    ...
                    <motion.div
                        ...
                        style={{
                            animation:
                                "pulse-border-glow 2s ease-in-out infinite",
                        }}
                    >
                        ...
                        <div className="flex flex-col gap-3 sm:gap-4 items-center text-center mb-6 sm:mb-8">
                            ...
                            <p className="font-['Nunito:Regular',_sans-serif] font-normal text-[#6b7280] text-[14px] sm:text-[16px] md:text-[18px] leading-relaxed max-w-[280px] sm:max-w-[350px] md:max-w-[400px] px-2">
                                Share your ideas, questions, or partnership
            ...
            <div className="hidden lg:flex content-stretch items-center relative w-full gap-16 px-8 lg:px-12">
                ...
                <div className="content-stretch flex flex-col gap-[32px] items-start relative flex-1 max-w-[520px] z-[2]">
                    <div className="flex flex-col gap-[20px] items-start w-full">
                        ...
                        <ContactFormSubtitle
                            isInView={desktopContainerInView}
                        />
                    </div>
                    ...
                    <motion.div
                        ...
                        style={{
                            animation:
                                "pulse-border-glow 2.5s ease-in-out infinite",
                        }}
                    >
...
export default function App() {
    const [currentPage, setCurrentPage] = useState<
        "home" | "about" | "explore" | "crowdfunding"
    >("home");
                    ...
                    <defs>
                        ...
                        >
                            ...
                            <feComponentTransfer>
                                <feFuncA
                                    type="discrete"
                                    tableValues="0.5 0.6 0.7 0.8 0.9 1"
                                />
                            </feComponentTransfer>
                            <feComposite
                                in2="SourceGraphic"
