...
function FamiliesSection() {
    ...
    const familiesInView = useInView(familiesRef, { once: true, margin: "-10%" });
        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
                ...
                <div ref={familiesRef} className="text-center mb-4">
                    ...
                    >
                        <motion.span 
                            ...
                            transition={{ duration: 0.8, delay: familiesInView ? 0.3 : 0, ease: [0.25, 0.46, 0.45, 0.94] }}
                            style={{ display: 'inline-block', marginRight: '0.3em' }}
                        >
                            For
                        </motion.span>
                        <motion.span 
                            className={`chroma-text-supercharged ${animateFamilies ? 'chroma-text-supercharged-animate' : ''}`}
                            initial={{ y: 100, opacity: 0 }}
                            animate={{ 
                                y: familiesInView ? 0 : 100, 
                                opacity: familiesInView ? 1 : 0 
                            }}
                            transition={{ duration: 0.8, delay: familiesInView ? 0.5 : 0, ease: [0.25, 0.46, 0.45, 0.94] }}
                ...
                <motion.div
                    ...
                    animate={{ y: familiesInView ? 0 : 30, opacity: familiesInView ? 1 : 0 }}
                    transition={{ duration: 0.8, delay: familiesInView ? 1.2 : 0, ease: "easeOut" }}
                >
                    <p className="font-['Nunito:Regular',_sans-serif] md:text-[20px] xl:text-[22px] text-white/90 leading-relaxed max-w-[600px] mx-auto text-[20px]">
                        <span className="whitespace-nowrap">Progress report card data and information to help your kid thrive.</span>
                        <br />
      ...
      <div className="content-stretch flex gap-2.5 items-start justify-center relative shrink-0 w-full">
        <div className="font-['Nunito:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#d5adff] text-[0px] text-center text-nowrap tracking-[1.02px]">
          <p className="font-['Nunito:Bold',_sans-serif] font-bold leading-[1.1] text-[48px] md:text-[56px] lg:text-[64px] whitespace-pre">
            ...
            <span className={`chroma-text-supercharged ${animateJourney ? 'chroma-text-supercharged-animate' : ''}`}>Journey</span>
          </p>
        </div>
      </div>
      <div className="content-stretch flex flex-col gap-[10px] items-start justify-center relative shrink-0 w-full">
        <div className="font-['Nunito:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#8c92ab] text-[18px] text-center tracking-[0.36px] w-full">
          <p className="leading-[27px]">
            ...
            <br aria-hidden="true" />
            Join us on this transformative journey to revolutionize STEM education.
          </p>
        </div>
      </div>
    </div>
  ...
  const timelineItems = [
    {
      ...
      description: "Initial product testing with select educators and students",
      delay: 0.3
    },
    {
      period: "JUL - SEP", 
      title: "MVP 1 Crowdfunding campaigns",
      description: "Launch fundraising to support full development and expansion",
      delay: 0.5
    },
    {
      period: "OCT - DEC",
      title: "Continue testing, start developing for MVP 2",
      description: "Iterate based on feedback and begin next-generation features",
      delay: 0.7
    }
  ];
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
      {timelineItems.map((item, index) => (
        <motion.div
          ...
          transition={{ duration: 0.8, delay: isInView ? item.delay : 0, ease: "easeOut" }}
...
function ExploreRoadmap({ onNavigate, onConfetti }: { onNavigate?: ExploreProps['onNavigate']; onConfetti?: (position: { x: number; y: number }) => void }) {
    const sectionRef = useRef(null);
    const sectionInView = useInView(sectionRef, { once: true, margin: "-20%" });

    return (
        <section ref={sectionRef} className="backdrop-blur-[11.5px] backdrop-filter relative rounded-[24px] w-full py-16 md:py-20">
            <div className="flex flex-col items-center relative w-full">
                <div className="box-border content-stretch flex flex-col gap-[56px] items-center px-[32px] relative w-full max-w-6xl">
                    ...
                    <motion.div
                        ...
                        animate={{ y: sectionInView ? 0 : 60, opacity: sectionInView ? 1 : 0 }}
                        transition={{ 
                            duration: 0.8, 
    ...
    return (
        ...
        >
            ...
            <div 
                ...
                style={{
                    background: "linear-gradient(135deg, #0f0224, #1a0238, #200440, #230c4a, #240d4d, #2a155a, #1e0d3d)"
                }}
            />
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                ...
                <div 
                    ...
                    style={{ 
                        ...
                        boxShadow: '0 0 6px rgba(255, 255, 255, 0.8), 0 0 12px rgba(213, 173, 255, 0.4)'
                    }}
                />
                <div 
                    ...
                    style={{ 
                        ...
                        boxShadow: '0 0 6px rgba(255, 255, 255, 0.7), 0 0 12px rgba(134, 20, 255, 0.3)'
                    }}
                />
                <div 
                    ...
                    style={{ 
                        ...
                        boxShadow: '0 0 4px rgba(255, 255, 255, 0.9), 0 0 8px rgba(109, 0, 224, 0.5)'
                    }}
                />
                <div 
                    ...
                    style={{ 
                        bottom: '30%', 
                        right: '15%',
                        animation: 'twinkle-large 3.5s ease-in-out infinite 0.5s',
                        boxShadow: '0 0 6px rgba(255, 255, 255, 0.8), 0 0 12px rgba(213, 173, 255, 0.4)'
                    }}
                />
                <div 
                    ...
                    style={{ 
                        bottom: '15%', 
                        left: '25%',
                        animation: 'twinkle-large 4.5s ease-in-out infinite 1.5s',
                        boxShadow: '0 0 4px rgba(255, 255, 255, 0.9), 0 0 8px rgba(134, 20, 255, 0.3)'
                    }}
                />
                ...
                <div 
                    ...
                    style={{ 
                        top: '20%', 
                        left: '35%',
                        animation: 'twinkle-medium 2s ease-in-out infinite 0.3s'
                    }}
                />
                <div 
                    ...
                    style={{ 
                        top: '35%', 
                        right: '40%',
                        animation: 'twinkle-medium 2.8s ease-in-out infinite 1.2s'
                    }}
                />
                <div 
                    ...
                    style={{ 
                        top: '55%', 
                        left: '45%',
                        animation: 'twinkle-medium 3.2s ease-in-out infinite 2.1s'
                    }}
                />
                <div 
                    ...
                    style={{ 
                        bottom: '35%', 
                        left: '70%',
                        animation: 'twinkle-medium 2.5s ease-in-out infinite 0.8s'
                    }}
                />
                <div 
                    ...
                    style={{ 
                        bottom: '20%', 
                        right: '30%',
                        animation: 'twinkle-medium 3.5s ease-in-out infinite 1.8s'
                    }}
                />
                ...
                <div 
                    ...
                    style={{ 
                        top: '18%', 
                        left: '55%',
                        animation: 'twinkle-small 1.5s ease-in-out infinite 0.5s'
                    }}
                />
                <div 
                    ...
                    style={{ 
                        top: '30%', 
                        left: '75%',
                        animation: 'twinkle-small 2.2s ease-in-out infinite 1.1s'
                    }}
                />
                <div 
                    ...
                    style={{ 
                        top: '50%', 
                        right: '25%',
                        animation: 'twinkle-small 1.8s ease-in-out infinite 1.7s'
                    }}
                />
                <div 
                    ...
                    style={{ 
                        bottom: '40%', 
                        left: '15%',
                        animation: 'twinkle-small 2.5s ease-in-out infinite 0.9s'
                    }}
                />
                <div 
                    className="absolute w-0.5 h-0.5 bg-white rounded-full opacity-40"
                    style={{ 
                        bottom: '25%', 
                        right: '55%',
                        animation: 'twinkle-small 1.9s ease-in-out infinite 1.4s'
                    }}
                />
                <div 
                    className="absolute w-0.5 h-0.5 bg-white rounded-full opacity-35"
                    style={{ 
                        top: '40%', 
                        left: '90%',
                        animation: 'twinkle-small 2.1s ease-in-out infinite 0.7s'
                    }}
                />
                <div 
                    className="absolute w-0.5 h-0.5 bg-white rounded-full opacity-40"
                    style={{ 
                        bottom: '50%', 
                        right: '10%',
                        animation: 'twinkle-small 1.7s ease-in-out infinite 2.3s'
                    }}
                />
            </div>
            ...
            <div className="relative z-10">
                ...
                >
                    <div className="w-full">
                        <ExploreHero onNavigate={onNavigate} onConfetti={onConfetti} />
                    </div>
                </section>
                    ...
                    <div className="flex flex-col lg:hidden gap-8 items-center text-center max-w-lg mx-auto px-4 py-20">
                        ...
                        >
                            <h2 className="font-['Nunito:Bold',_sans-serif] font-bold text-[42px] md:text-[48px] text-white leading-tight">
                                For <span className="chroma-text-supercharged chroma-text-supercharged-animate">Kids</span>
                            </h2>
                        </motion.div>
                        ...
                        <div className="w-full max-w-[380px] flex flex-col gap-6 text-left">
                            ...
                            >
                                <p className="font-['Nunito:Regular',_sans-serif] text-[18px] text-white/90 leading-relaxed text-center">
                                    Interactive STEM adventures where every child becomes the hero of their own learning journey
                                </p>
                            </motion.div>
                            ...
                            >
                                ...
                                <div className="flex items-start gap-3">
                                    <div className="flex-shrink-0 w-4 h-4 border-2 rounded-[4px] border-[#70e2d8] bg-[#70e2d8]/25 mt-1">
                                    </div>
                                    <div className="flex-1">
                                        ...
                                        <p className="font-['Nunito:Regular',_sans-serif] text-white/60 text-[14px] leading-relaxed">
                                            AI-guided challenges with age-appropriate educational content.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="font-['Nunito:Regular',_sans-serif] text-white/60 text-[14px] leading-relaxed">
                                            Adventures and quests that make STEM stick.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="font-['Nunito:Regular',_sans-serif] text-white/60 text-[14px] leading-relaxed">
                                            Every child sees themselves as the hero.
                                        </p>
                                    </div>
                                </div>
                            </motion.div>
...
{(() => {
                                ...
                                return (
                                    <h2 className="font-['Nunito:Bold',_sans-serif] font-bold text-[38px] md:text-[48px] lg:text-[58px] xl:text-[68px] leading-[1.1] mb-6 overflow-hidden">
                                        <span className="text-[rgba(255,255,255,1)]" style={{ display: 'inline-block', marginRight: '0.3em' }}>
                                            For
                                        </span>
                                        <span className={`chroma-text-supercharged ${animateKids ? 'chroma-text-supercharged-animate' : ''}`} style={{ display: 'inline-block' }}>
                                            Kids
                                        </span>
                                    </h2>
                                );
                ...
                >
                    ...
                    <ExploreRoadmap onNavigate={onNavigate} onConfetti={onConfetti} />
                </section>
