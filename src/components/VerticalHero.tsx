...
function Frame61564() {
  ...
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0 w-full">
      <div ref={titleRef} className="content-stretch flex flex-col gap-[7px] items-center text-center leading-[0] relative w-full max-w-4xl">
        <div className="font-['Nunito:Bold',_sans-serif] font-bold relative text-[#d5adff] leading-tight overflow-hidden">
          <motion.p 
            className="mb-0 text-[48px] md:text-[56px] lg:text-[64px] leading-[1.25]"
            initial={{ opacity: 0 }}
          ...
          >
            {words.map((word, index) => {
              ...
              if (word === "win") {
                ...
                return (
                  <span key={`win-in-stem-${index}`} style={{ whiteSpace: 'nowrap' }}>
                    <motion.span
                      className=""
                    ...
                    <motion.span
                      ...
                      transition={{ 
                        duration: 0.8, 
                        delay: titleInView ? (index + 1) * 0.2 : 0,
                        ease: [0.25, 0.46, 0.45, 0.94]
                      }}
                      style={{ display: 'inline-block', marginRight: '0.3em' }}
                    >
                    ...
                    <motion.span
                      ...
                      transition={{ 
                        duration: 0.8, 
                        delay: titleInView ? (index + 2) * 0.2 : 0,
                        ease: [0.25, 0.46, 0.45, 0.94]
                      }}
    ...
    <div className="content-stretch flex flex-col lg:flex-row gap-[40px] lg:gap-[80px] items-center justify-center lg:justify-around relative shrink-0 w-full max-w-6xl">
      ...
      <div className="flex flex-col gap-[32px] items-center lg:items-start lg:flex-1 lg:ml-[120px] order-2 lg:order-1">
        ...
        >
          <div className="bg-white border border-[#e0daef] rounded-[16px] px-3 py-2 flex items-center gap-[8px]">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="#deb020"/>
            </svg>
            <span className="text-[#4c1d95] font-['Nunito:Bold',_sans-serif] font-bold text-[14px]">Our Mission & Vision</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col gap-[8px] items-center lg:items-start text-center lg:text-left font-['Nunito:Regular',_sans-serif] font-normal text-[#737992]">
            <p className="font-['Nunito:Bold',_sans-serif] font-bold text-[20px] lg:text-[24px] leading-[27px] text-[#8614ff]">Mission</p>
            <p className="text-[16px] lg:text-[18px] leading-[26px] max-w-[400px]">Empower every kid to win in STEM</p>
          </div>

          {/* Vision */}
          <div className="flex flex-col gap-[8px] items-center lg:items-start text-center lg:text-left font-['Nunito:Regular',_sans-serif] font-normal text-[#737992]">
            <p className="font-['Nunito:Bold',_sans-serif] font-bold text-[20px] lg:text-[24px] leading-[27px] text-[#8614ff]">Vision</p>
            <p className="text-[16px] lg:text-[18px] leading-[26px] max-w-[400px]">Make STEM culturally relevant so every kid, everywhere, can succeed.</p>
          </div>
        </motion.div>
      </div>
      ...
      <div className="lg:flex-1 flex justify-center lg:justify-end order-1 lg:order-2">
        <motion.div 
          ...
          initial={{ x: 30, opacity: 0 }}
          animate={{ x: isInView ? 0 : 30, opacity: isInView ? 1 : 0 }}
          transition={{ duration: 0.8, delay: isInView ? 1.4 : 0, ease: "easeOut" }}
        />
      </div>
    </div>
  );
