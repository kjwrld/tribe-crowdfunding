    ...
    <Portal.Root>
      <div
        className={cn(
          ...
          context.darkMode ? 'bg-black/40 backdrop-blur-sm' : 'bg-white/30 backdrop-blur-sm',
  ...
  return (
    ...
    >
      <Portal.Root>
        <div
          className={cn(
            'pointer-events-none fixed inset-0 z-[10000] mx-auto flex w-full max-w-lg flex-col items-center justify-center',
            className
          )}
          {...props}
        >
