...
import dashboardImage from "../assets/webp/3606a7520ab77fa7198e35a59aac25f2b54aa822.webp";
        ...
        >
            <div className="relative z-10">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="text-[10px] text-[#70e2d8] font-medium">
                        {trend}
                    </div>
                </div>
                <div
            ...
            >
                <h4 className="font-['Nunito:Bold',_sans-serif] text-white text-[16px] relative">
                    ...
                    <motion.div
                        ...
                        style={{
                            background:
                                "radial-gradient(circle at center, rgba(213, 173, 255, 0.15), transparent 70%)",
                            filter: "blur(8px)",
                        }}
                    />
                </h4>
            ...
            <div className="flex items-end justify-between h-[87px] gap-[16px] ml-[31px] relative">
                {chartData.map((data, index) => {
                    ...
                    return (
                        <div
                            key={data.day}
                            className="flex flex-col items-center gap-[7px] w-[30px] relative"
                        >
                            {/* Hover Tooltip */}
                            {isHovered && (
                                <motion.div
                            ...
                            <motion.div
                                ...
                                initial={{ height: 4 }}
                                animate={{
                                    height: isInView ? Math.max(height, 4) : 4,
                                }}
                                transition={{
                                    duration: 0.8,
                                ...
                                {isHovered && (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            animation:
                                                "subtle-shine 2s ease-in-out infinite",
                                        }}
                                    />
                                )}
                            </motion.div>
                            ...
                            >
                                <span
                                    ...
                                    style={{
                                        ...
                                        textShadow: isHovered
                                            ? "0 0 8px rgba(209, 174, 255, 0.8), 0 0 16px rgba(209, 174, 255, 0.6), 0 0 24px rgba(209, 174, 255, 0.4)"
                                            : "none",
                                    }}
                                >
                                    {data.day}
            ...
            <div className="content-stretch flex flex-col h-auto items-start justify-center pb-[28px] pt-[28px] px-[15px] relative w-full gap-6">
                ...
                >
                    <div className="font-['Nunito:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[0px] text-nowrap">
                        <p className="font-['Nunito:Bold',_sans-serif] font-bold leading-[normal] text-[16px] whitespace-pre text-white font-normal">
                            Screen Time
                        </p>
                    </div>
                </motion.div>
            ...
            <CursorProvider className="hidden lg:block w-full relative">
                <div ref={desktopRef} className="w-full h-full">
                    ...
                    <motion.div
                        ...
                        style={{
                            background:
                                "radial-gradient(circle at center, rgba(134, 20, 255, 0.02), transparent 70%)",
                            filter: "blur(20px)",
                        }}
          ...
          `,
                    ...
                    >
                        ...
                        <div
                            ...
                            onMouseEnter={() =>
                                setCurrentSection("Performance Overview")
                            }
                            onMouseLeave={() => setCurrentSection("")}
                        >
                            <div
                                onMouseEnter={() =>
                                    setCurrentSection("Overall Progress")
                                }
                            >
                                <StatCard
                            ...
                            <div
                                onMouseEnter={() =>
                                    setCurrentSection("Active Subjects")
                                }
                            >
                                <StatCard
                            ...
                            <div
                                onMouseEnter={() =>
                                    setCurrentSection("Completion Rate")
                                }
                            >
                                <StatCard
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div
                                ...
                                onMouseEnter={() =>
                                    setCurrentSection("Subject Progress Table")
                                }
                                onMouseLeave={() => setCurrentSection("")}
                            >
                                <motion.div
                        ...
                        <motion.div
                            ...
                            onMouseEnter={() =>
                                setCurrentSection("Dashboard Actions")
                            }
                            onMouseLeave={() => setCurrentSection("")}
                        >
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onMouseEnter={() =>
                                    setCurrentSection("View Details")
                                }
                            >
                                <svg
                                    className="w-5 h-5"
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onMouseEnter={() =>
                                    setCurrentSection("Share Progress")
                                }
                            >
                                <svg
                                    className="w-5 h-5"
                                ...
                                >
                                    <path
                                        ...
                                        strokeLinejoin="round"
                                        strokeWidth={2}
                                        d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 010-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.367 2.684 3 3 0 00-5.367-2.684z"
                                    />
                                </svg>
                            </motion.button>
                        </motion.div>
