...
export function ThankYouEmailTemplate({
    ...
    return (
        ...
        >
            ...
            >
                Your generous donation will help transform STEM education and
            ...
            <div
                style={{
                    backgroundColor:
                        "linear-gradient(to right, #8614ff, #6d00e0)",
                    background: "#8614ff",
                    borderRadius: "16px",
                    padding: "12px 24px",
                    textAlign: "center",
            ...
            >
                <a
                    href="https://younggiftedbeautiful.org"
                    style={{
                        color: "#ffffff",
                        textDecoration: "none",
                        fontFamily: "Nunito, Arial, sans-serif",
            ...
            >
                ...
                >
                    This email was sent by YGBVerse. If you have any questions,
                    please contact us at info@younggiftedbeautiful.org
                </p>
            </div>
        </div>
    );
...
export function generateThankYouEmailHTML(
    firstName: string,
    amount: string,
    type?: string
): string {
